                ...
                <Box sx={{ display: "flex", flexWrap: "wrap", gap: 3 }}>
                    ...
                    >
                        ...
                        <ResponsiveContainer width="100%" height={300}>
                            ...
                            >
                                ...
                                {/* Tooltip melhorada */}
                                <Tooltip
                                    formatter={(value) => `${value} Encomendas`}
                                />
                    ...
                    <Card
                        sx={{
                            flex: 1,
                            p: 2,
                            minWidth: smallerThanMedium ? "100%" : "350px",
                        }}
                    >
                        <Typography variant="h6" sx={{ mb: 2 }}>
...
<Card sx={{ flex: 1, p: 2, minWidth: smallerThanMedium ? "100%" : "350px" }}>
    <Typography variant="h6" sx={{ mb: 2 }}>
