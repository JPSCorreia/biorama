...
const FormCompanyRegistration = forwardRef(
    ({ formErrors, onCloseCompanyForm }, refCompany) => {
        ...
        const handlePostalCodeChange = async (e) => {
            ...
            if (value.length === 8 && postalCodeRegex.test(value)) {
        ...
        const validationSchema = yup.object().shape({
            ...
            phone: yup.string().required("O número de telemóvel é obrigatório"),

            // Tabela company_addresses
            street: yup.string().required("A morada é obrigatória"),
            postal_code: yup.string().required("O código postal é obrigatório"),
            number: yup.string().required("O número é obrigatório"),
            district: yup.string().required("A cidade é obrigatória"),
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <IconButton onClick={onCloseCompanyForm} aria-label="close">
                        <CloseIcon />
                    </IconButton>
                </Box>
