...
const DashboardEditProduct = observer(({ product, onCancel, onSubmit, storeId }) => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        discount: Yup.number().min(0, "O desconto não pode ser negativo").nullable(),
        stock: Yup.number().min(0, "O stock não pode ser negativo").required("Stock é obrigatório"),
    ...
    return (
        <Box component="form" onSubmit={formik.handleSubmit} sx={{ mt: 3, pt: 3 }}>
